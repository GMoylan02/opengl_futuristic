...
void AnimatedModel::computeLocalNodeTransform(const tinygltf::Model& model,
        int nodeIndex,
...
std::vector<AnimatedModel::SkinObject> AnimatedModel::prepareSkinning(const tinygltf::Model &model) {
...
std::vector<AnimatedModel::AnimationObject> AnimatedModel::prepareAnimation(const tinygltf::Model &model)
{
...
void AnimatedModel::updateSkinning(const std::vector<glm::mat4> &nodeTransforms) {
...
bool AnimatedModel::loadModel(tinygltf::Model &model, const char *filename) {
...
void AnimatedModel::bindMesh(std::vector<PrimitiveObject> &primitiveObjects,
...
void AnimatedModel::bindModelNodes(std::vector<PrimitiveObject> &primitiveObjects,
...
std::vector<AnimatedModel::PrimitiveObject> AnimatedModel::bindModel(tinygltf::Model &model) {
...
void AnimatedModel::drawMesh(const std::vector<PrimitiveObject> &primitiveObjects,
				tinygltf::Model &model, tinygltf::Mesh &mesh) {
...
void AnimatedModel::drawModelNodes(const std::vector<PrimitiveObject>& primitiveObjects,
...
void AnimatedModel::drawModel(const std::vector<PrimitiveObject>& primitiveObjects,
				tinygltf::Model &model) {
	// Draw all nodes
	const tinygltf::Scene &scene = model.scenes[model.defaultScene];
	for (size_t i = 0; i < scene.nodes.size(); ++i) {
...
void AnimatedModel::render(glm::mat4 cameraMatrix) {
...
void AnimatedModel::printJointMatrices(const std::vector<glm::mat4>& jointMatrices) {
