...
// Lighting
static glm::vec3 botLightIntensity(5e6f, 5e6f, 5e6f);
static glm::vec3 botLightPosition(-275.0f, 500.0f, 800.0f);
...
struct MyBot {
	...
	void render(glm::mat4 cameraMatrix) {
		...
		// Set light data 
		glUniform3fv(lightPositionID, 1, &botLightPosition[0]);
		glUniform3fv(lightIntensityID, 1, &botLightIntensity[0]);
