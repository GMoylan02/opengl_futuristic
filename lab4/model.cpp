...
void Model::computeGlobalNodeTransform(const tinygltf::Model& model,
                                int nodeIndex,
...
void Model::initialize(glm::vec3 position, glm::vec3 scale, const char* filename) {
...
void Model::bindMesh(std::vector<PrimitiveObject>& primitiveObjects,
